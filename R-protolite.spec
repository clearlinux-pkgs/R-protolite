...
Version  : 2.1.3
Release  : 41
URL      : https://cran.r-project.org/src/contrib/protolite_2.1.3.tar.gz
Source0  : https://cran.r-project.org/src/contrib/protolite_2.1.3.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1666842697
